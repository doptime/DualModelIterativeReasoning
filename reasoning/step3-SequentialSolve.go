...
// 	Solvermessages := message.User(`Given a question, and solution together with Improvement Suggestions. Further improve the solution to solve the problem, by follow these steps:
...
// 		if NewBestTrail.Solution, err = models.SLM1.AskLLM(0.7, false, SysPromptBasic, node.UserMsg, bestAnswerNode.Solution, bestAnswerNode.Refinement("improvement Suggestions"), Solvermessages); err != nil {
// 			fmt.Println("Error: ", err)
// 			continue
// 		}
// 		if NewBestTrail.Solution, err = models.SLM2.AskLLM(0.7, false, node.UserMsg, NewBestTrail.Solution, message.User(`
